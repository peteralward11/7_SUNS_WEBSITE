      ...
      <div style={{
        ...
        {[
          ...
          <div key={l} style={{ display: "flex", gap: 14, marginBottom: 7 }}>
            <span style={{ fontSize: 12, color: T.muted, fontWeight: 500, minWidth: 68, flexShrink: 0 }}>{l}</span>
...
export default function BookingModal() {
  ...
  useEffect(() => {
    if (!isOpen) {
      const t = setTimeout(() => { setStep(1); setForm(INITIAL); setStatus("idle"); setErrors({}); }, 350);
    ...
    try {
      ...
      const res = await fetch("/api/book", {
        ...
        body: JSON.stringify({
          ...
          project_type: form.project_type, address: form.address, appliances,
  ...
  return (
    <div
      style={{
        ...
        transition: "opacity 0.25s", opacity: isOpen ? 1 : 0, pointerEvents: isOpen ? "auto" : "none",
      }}
      onClick={e => { if (e.target === e.currentTarget) close(); }}
    >
      <div style={{
        position: "relative", display: "flex", flexDirection: "column",
        width: "100%", maxWidth: 580, height: "min(92vh, 700px)",
        backgroundColor: "#FFFFFF",
        borderRadius: 20,
        boxShadow: "0 32px 80px rgba(12,20,32,0.18), 0 8px 24px rgba(12,20,32,0.1)",
          ...
          <div style={{ padding: "18px 28px 20px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
              <p style={{
                ...
                textTransform: "uppercase", color: T.green, lineHeight: 1,
              }}>
                7 Suns Delivery
              </p>
              {/* Close button */}
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = T.border; (e.currentTarget as HTMLButtonElement).style.color = T.navy; }}
        ...
        <div ref={scrollRef} style={{ flex: 1, overflowY: "auto", padding: "28px 28px 8px" }}>
          {status === "success" ? (
            <div style={{
              ...
              <h2 style={{ fontSize: 22, fontWeight: 700, color: T.navy, letterSpacing: "-0.02em", fontFamily: "var(--font-display)", marginBottom: 10 }}>
            ...
            <>
              {/* Step heading — Fraunces display font for character */}
              <h2 style={{
