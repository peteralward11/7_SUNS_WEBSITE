      ...
      <div className="fp-drawer" style={{
        ...
        <div className="fp-drawer-header-mobile" style={{ padding: "6px 16px 10px 4px" }}>
          ...
          <div style={{ flex: 1, minWidth: 0, paddingLeft: 4 }}>
            <p style={{ fontSize: "10px", color: "var(--text-3)", margin: 0, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>New Job</p>
            <p style={{ fontSize: "16px", fontWeight: 700, margin: 0, color: "var(--text)" }}>{customerName || "Create Job"}</p>
          </div>
        </div>
